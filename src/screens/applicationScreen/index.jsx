...
const ApplicationScreen = ({navigation}) => {
  ...
  return (
    <View style = {{
      ...
      <Pressable onPress = {() => {navigation.navigate('SafetyAndSecurityScreen')}}  style = {{ backgroundColor : 'brown', width : '100%', marginVertical : 20, alignItems : 'center', justifyContent : 'center', bottom : 0, paddingVertical : 20, flexDirection : 'row',}}>
