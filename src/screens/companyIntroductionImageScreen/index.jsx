...
const CompanyIntroductionImageScreen = ({navigation}) => {
        ...
        uploadTask.on(
          ...
          () => {
            getDownloadURL(uploadTask.snapshot.ref).then((downloadedURL) => {
              ...
              setUrl((prev) => ({ ...prev, img: downloadedURL }));
            });
          }
        );
...
export default CompanyIntroductionImageScreen
