...
const BirthCertificateImageScreen = ({navigation, route}) => {

  const {birthCertificate} = route.params
  ...
  const uploadMedia = async() => {
    ...
    try {
        ...
        Alert.alert("Birth Certificate has been uploaded successfully!!!")
  ...
  const deleteImage = () => {
    ...
    deleteObject(deleteRef).then(async() => {
        ...
        setUrl(null)
        // navigation.navigate("birthCertificateImageScreen")
  ...
  return (
    <View style={{flex:1, alignItems:'center', justifyContent:'space-between', flexDirection:'column', padding:20}}>
        ...
        <View style={{width:'100%', alignItems:'center', flexDirection:'row', justifyContent:'space-between'}}>
            ...
            <Text style={{fontSize:18, fontWeight:'bold', color:COLORS.main, marginRight:10}}>{`Upload ${birthCertificate && 'Birth Certificate' }`}</Text>
        </View>
...
export default BirthCertificateImageScreen
