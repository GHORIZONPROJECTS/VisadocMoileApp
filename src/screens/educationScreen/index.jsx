     ...
     <View style={{marginBottom:50}}>
        ...
        {/* <Text style={{fontSize:16, marginBottom:5, fontWeight:'500'}}>Please Fill in this Information as it is in your International Passport</Text> */}
            ...
            <View style={{marginBottom:20}}>
                ...
                <Text style={{fontSize:16, marginBottom:0}}>What is your Level of Education</Text>
                ...
                return (
                    <View key= {item.value} style={{flexDirection: 'column', justifyContent:'flex-start', marginVertical:10, marginRight:100}}>
                        ...
                        <Pressable key= {item.value} onPress={() => setMarried(item.value)} style={{
                        width:30,
                        height:30,
                        ...
                        borderColor: married == item.value? COLORS.main : 'lightgray',
                        position:'relative'
                    
                        }}>
                        {married === item.value ? <View style={styles.check}>
                        ...
                        <Text style={{
                            fontSize:13,
                            color: married == item.value? COLORS.main : 'black',
                        }}>
                            {item.title}
                        </Text>
